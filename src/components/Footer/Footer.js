    ...
    return (
      <div className=" border-t-2 border-gray-700">
        <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
          ...
          <div className="sm:flex sm:items-center sm:justify-between text-center mt-5">
            <p className=" dark:text-white">
              copyright &copy; {getCurrentYear()} Bookly{" "}
              <small>by Md Nozib Ud Dowla.</small> All Rights Reserved.
            </p>
